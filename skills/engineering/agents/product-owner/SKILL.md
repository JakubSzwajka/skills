...
No nested helper skills are currently defined for product-owner. Use the product steward persona directly and delegate to other agents only when their role-specific judgment is needed.
