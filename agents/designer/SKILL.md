...
name: agent-designer
description: >
  Start a design steward session. Use when discussing UI/UX, flows, brand,
  copy voice, interaction patterns, visual direction, accessibility, or when
  another planning skill needs design guidance.
---
