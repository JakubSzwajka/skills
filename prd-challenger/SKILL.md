...
For each major claim or assumption in the PRD, verify it against the codebase. Use `/deep-research` or the Explore agent for thorough investigation. Focus on these verification axes:
